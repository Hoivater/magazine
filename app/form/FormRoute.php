...
require "../../autoload.php";
	...
	class FormRoute extends FormBase
	{
		...
		private function routeF($name_form)
		{
			...
			elseif($name_form == 'cleanHistory')
			{
				$this -> cleanHistory();
			}
			elseif($name_form == 'saveGpr')
			{
				$this -> saveGprF();
			}
			elseif($name_form == 'redactionGpr')
			{
				$this -> redactionGprF();
			}
			elseif($name_form == 'nextGpr')
			{
				$this -> nextGprF();
			}
			...
			elseif($name_form == 'new_tags')
			{
				if(isset($this -> data["newtags"]))
					$this -> result = Site\TagsTable::addTags($this -> data);
			}

			elseif($name_form == 'newReport')
			{
				$this -> result = Site\ReportTable::ReportRun($this -> data);
			}
			elseif($name_form == 'new_date')
			{
				$this -> result = Site\NoteTable::NewDate($this -> data);
			}
