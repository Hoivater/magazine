...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 09, 2023 at 05:39 PM
...
(1, 'Меню', 0, 'bolon', 'rect846.png'),
(2, 'Новости', 1, 'bochag', 'aktsiya.jpg'),
(3, 'Пряжа', 1, 'morshi', 'rect846.png'),
(4, 'Крючки', 1, 'mader', 'rect846.png'),
(5, 'Дополнительно', 1, 'blast', 'rect846.png'),
(11, 'Коробки', 1, 'corobki', 'rect846.png'),
(12, 'Игрушки', 1, 'igrushki', 'rect846.png');

-- --------------------------------------------------------

--
-- Table structure for table `fr3452_toys`
--

CREATE TABLE `fr3452_toys` (
  `id` int UNSIGNED NOT NULL,
  ...
  `keywords` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `description_main` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `manufacturer` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `structure` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `weight` int NOT NULL,
  `length` int NOT NULL,
  `forinstrument` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `complect` tinyint(1) NOT NULL,
...
(1, 'limb', 'limb@limb.ru', 'b59c67bf196a4758191e42f76670ceba', 'admin', 'no', 'dLDIDEZsre87MBuLApPJJVJPCE4sLlc2O', 1682795834),
(2, 'user', 'user@user.ru', 'b59c67bf196a4758191e42f76670ceba', 'user', 'no', 'HuwpD6gBmzMJ2y84SG98ZkyIiELNP8UPO', 1683622177);
...
--
-- Indexes for table `fr3452_toys`
--
ALTER TABLE `fr3452_toys`
  ADD UNIQUE KEY `id` (`id`);
...
--
-- AUTO_INCREMENT for table `fr3452_toys`
--
ALTER TABLE `fr3452_toys`
